    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('durum', models.CharField(choices=[('BEKLEMEDE', 'Beklemede'), ('ONAYLANDI', 'Onaylandı'), ('REDDEDILDI', 'Reddedildi'), ('REVIZYON', 'Revizyon Bekliyor')], default='BEKLEMEDE', max_length=20)),
